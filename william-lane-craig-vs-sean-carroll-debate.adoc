...
* Bayesian analysis and Occam's razor would seemingly point to a simple theory, but our observations preclude the simplest available, such as nothing concrete exists, and that logically possible sentient experiences occur with equal probability despite our own existence.
